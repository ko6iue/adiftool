...
html/assets/adiftool.js: adiftool.c maidenhead.c adif.c emscripten.c kml.c geojson.c cmdline.c counter.c
...
adiftool: adiftool.c maidenhead.c adif.c kml.c geojson.c cmdline.c counter.c counter.h
	gcc -Wall -W -g -o $@ $^ -lm
