...
const char *gengetopt_args_info_purpose = "Commandline tool for converting ADIF to various other GIS formats";

const char *gengetopt_args_info_usage = "Usage: adiftool [OPTION]...";
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'o':	/* File to write output to..  */
          ...
          break;
        case 'g':	/* Output GeoJSON instead of KML.  */
